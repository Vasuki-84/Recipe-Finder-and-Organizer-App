...
function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen  bg-[url('https://i.pinimg.com/1200x/be/c6/6b/bec66b9c4e110e27abf664e9afc7065f.jpg')] bg-fixed bg-cover max-h-screen w-full" >
...
//   return (
//     <div className="flex flex-col items-center justify-center min-h-screen bg-[url('https://i.pinimg.com/1200x/be/c6/6b/bec66b9c4e110e27abf664e9afc7065f.jpg')] bg-fixed bg-cover w-full">
//       <div className="flex flex-col gap-5 text-center">
//         <h2 className="text-5xl mb-1 font-serif">All of your recipes in one place</h2>
//         <p className="text-xl text-gray-700 mb-5 font-mono">
//           A free recipe keeper and meal planner
//         </p>
//       </div>
...
//             type="text"
//             placeholder="Search recipes..."
//             className="w-full px-4 py-2 border border-gray-700 rounded-l-xl focus:outline-none focus:ring-2 focus:ring-green-500 text-gray-700 placeholder-gray-500 transition-all"
//           />
//           <button
//             type="button"
//             className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-r-xl hover:bg-green-700 transition-all group"
...
//         <h2 className="text-3xl font-semibold text-center mb-6">🍲 Your Delicious Recipes</h2>
//         {recipes.length === 0 ? (
//           <p className="text-center text-gray-500">
//             No recipes added yet. Go to <strong>Profile</strong> and add some!
//           </p>
...
//                   </div>
//                 )}
//                 <h3 className="text-xl font-bold mb-2 text-orange-600">{recipe.recipeName}</h3>
//                 <p className="text-gray-700 mb-2">
//                   <strong>Ingredients:</strong> {recipe.ingredients}
//                 </p>
//                 <p className="text-gray-700 mb-2">
